...
$(function () {
    ...
    // create test  suite named "The menu" */
    describe('MENU', function () {
        /* This test ensures the menu element is hidden by default. expect the class  'menu hidden' toBe (true) */
        var body = $('body');
        it('Is hidden by default', function () {
            expect(body.hasClass('menu-hidden')).toBeTruthy();
        });
        /* This test that ensures the menu changes when click
    ...
    /* created  test suite named "New Feed Selection"*/
